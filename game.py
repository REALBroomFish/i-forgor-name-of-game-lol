...
def normalise_input(user_input):
    ...
    'help'
    """
    input_without_spaces = remove_spaces(user_input)
    normalised = remove_punct(input_without_spaces)
    return normalised
...
def display_room(room):
    ...
    """
    # pass # The pass statement does nothing. Replace it with the body of your function.
    Name = map.rooms[room]["Name"]
    Desc = map.rooms[room]["Description"]
    print(str(Name))
    print()
    print(str(Desc))
    print()
...
def print_menu_line(direction, leads_to):
    ...
    """
    print("Go " + str(direction) + " to " + str(leads_to))
